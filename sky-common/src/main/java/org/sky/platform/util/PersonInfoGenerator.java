...
public class PersonInfoGenerator {
	private static Logger logger = LogManager.getLogger(PersonInfoGenerator.class);
	...
	private static final String[] email_suffix = "@gmail.com,@yahoo.com,@msn.com,@hotmail.com,@aol.com,@ask.com,@live.com,@qq.com,@0355.net,@163.com,@163.net,@263.net,@3721.net,@yeah.net,@googlemail.com,@126.com,@sina.com,@sohu.com,@yahoo.com.cn"
			.split(",");
	private static String[] storeIdArray = { "057", "020", "014", "042", "048", "043", "040", "041", "058", "026" };
	private static String[] nationalityArray = { "CHN", "AUS", "TUN", "TUR", "VGB" };

	private static String T_CHANNEL_ID = "2";
	...
	public static String getNationality() {
		...
		nationality = nationalityArray[randomIdx];
		return nationality;
	}

	public static String getStoreID() {
		String storeId = "";
		int randomIdx = (int) (Math.random() * 9);
		storeId = storeIdArray[randomIdx];
		return storeId;
	}
